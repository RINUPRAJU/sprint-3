...
<body>
	<header class="hidden-xs hidden-sm" style="background-color:#3b5998;">
    <div class="container">
  	  <div class="row">
  	    <div class="col-md-6 col-sm-4">
  	  	  ...
  	  	  <div class="row">
  	  		...
  	  		<form:form action="/Myspring/login" method="post" modelAttribute="loginBean" id="loginform"> 
  	  			...
  	  			<div class="col-md-2" >
               <input type="submit" id="log" value="login"style="background-color:white; color:darkblue;">
               </form:form>
               </div>
               </div>
...
<section class="hidden-xs hidden-sm" style="background-color:#dfe3ee;height:700px;">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-7">
				<h4><font color="#3b5998">Facebook help you connect and share <br>with the people in your life</font></h4>
